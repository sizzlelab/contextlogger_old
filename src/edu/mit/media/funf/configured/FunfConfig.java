...
/**
 * A convenience interface to access a Funf configuration stored in a SharedPreferences. All data is stored in the SharedPreferences, and all edits follow the same transaction  model as SharedPreferences.
 */
public class FunfConfig implements OnSharedPreferenceChangeListener {
	...
	public static final long 
		DEFAULT_VERSION = 0; // 1 hour
	public static final long DEFAULT_DATA_ARCHIVE_PERIOD = 3 * 60 * 60;
	public static final long DEFAULT_DATA_UPLOAD_PERIOD = 6 * 60 * 60;
	public static final long DEFAULT_CONFIG_UPDATE_PERIOD = 1 * 60 * 60;
