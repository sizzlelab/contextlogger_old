...
public abstract class ConfiguredPipeline extends CustomizedIntentService implements OnSharedPreferenceChangeListener {
	...
	public static final String ACTION_UPDATE_CONFIG = PREFIX + "update";
	public static final String ACTION_UPLOAD_DATA = PREFIX + "upload";
	public static final String ACTION_ARCHIVE_DATA = PREFIX + "archive";
