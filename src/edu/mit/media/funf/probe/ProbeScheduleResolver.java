...
public class ProbeScheduleResolver {
	...
	/**
	 * Calculates the soonest due date for a probe to be run, and returns it If this method returns 0 if there is no scheduled next time to run.
	 * @param lastRunTime
	 * @return
	 * @uml.property  name="nextRunTime"
	 */
