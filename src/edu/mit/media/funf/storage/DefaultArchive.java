...
/**
 * A default implementation of a file archive, which should be good enough for most cases. This archive provides internal memory and SD card redundancy, managed backups, as well as file encryption. Archives are singletons by database name.
 */
public class DefaultArchive implements Archive<File> {
	...
	/**
	 * @uml.property  name="delegateArchive"
	 * @uml.associationEnd  
	 */
	...
	public boolean add(File item) {
		System.out.println("DefaultArchive: add(File) called...");
