...
/**
 * A simple directory based archive for files.   A file may be able to be archived more than once depending on the nameGenerator strategy that is used.
 */
public class FileDirectoryArchive implements Archive<File> {
	...
	/**
	 * @uml.property  name="nameGenerator"
	 * @uml.associationEnd  
	 */
