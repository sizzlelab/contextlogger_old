...
/**
 * Delegates all actions to archive.  Adds an item to the backup archive before removing from the archive. It is up to the backup archive to determine when those items will remove themselves.
 */
public class BackedUpArchive implements Archive<File> {

	/**
	 * @uml.property  name="archive"
	 * @uml.associationEnd  
	 */
	private final Archive<File> archive;
	/**
	 * @uml.property  name="backupArchive"
	 * @uml.associationEnd  
	 */
